...
<div>
  ...
  {#if isLoading}
    <div
      class="hidden lg:fixed lg:top-0 mt-24 lg:inset-y-0 lg:z-50 lg:flex lg:w-64 lg:flex-col"
    >
      <!-- Sidebar component, swap this element with another sidebar if you like -->
      <div
                    ...
                    <li>
                      <a
                        ...
                        class="group {subItem.link == routeID
                          ...
                          : 'text-primary/60 '} capitalize mt-1 flex justify-between items-center gap-x-2.5 p-2 text-sm leading-6 select-none pl-3 py-[5.2px] border border-transparent rounded-sm dark:hover:bg-neutral-900 transition-all duration-300"
                      >
                        {subItem.name}
                        {#if subItem?.isNew}
  ...
  <div
    class="sticky top-24 z-40 flex items-center gap-x-6 dark:bg-background border-b bg-white backdrop-blur-md px-4 py-4 shadow-sm sm:px-6 lg:hidden"
  >
    <button
